...
//下記のパス「demo」を変更
include_once $_SERVER['DOCUMENT_ROOT'].'/page/korean-pop-week/assets/inc/config.php';
...
$pege_keywords = '';
$page_shareurl = 'https://'.STORE_NAME.'.parco.jp/page/korean-pop-week/'; //必ずディレクトリ名を変更する
...
<div class="loading">
    ...
    <div class="loading__body blur">
        <div class="video">
            <div class="pc-only">
                <video id="splash_ver_pc" muted playsinline width="100%">
                  <source src="/<?php echo DIRNAME; ?>/assets/video/splash_ver.mp4" type="video/mp4">
                </video>
            </div>

            <div class="sp-only">
                <video id="splash_ver_sp" muted playsinline width="100%" poster="/page/korean-pop-week/assets/images/poster.png">
                  <source src="/<?php echo DIRNAME; ?>/assets/video/splash_ver.mp4" type="video/mp4">
                </video>
            </div>
        </div>
...
<main class="main">
    <div class="nav hidden">
        <div class="nav-logo">
            <a href="" class="nav-logo__link">
                <img src="/<?php echo DIRNAME; ?>/assets/images/logo.webp" class="" alt="<?php echo $pege_title; ?>">
            </a>
        </div>
    ...
    <div class="main-video">
        ...
        <video id="main_video" class="pc-only" muted loop playsinline>
            <source src="/<?php echo DIRNAME; ?>/assets/video/movie-1920x1080-short.mp4" type="video/mp4" media="(min-width: 769px)">
            <source src="/<?php echo DIRNAME; ?>/assets/video/movie-1080x1920-short.mp4" type="video/mp4" media="(max-width: 768px)">
        </video>
    </div>
    ...
    <div class="content-wrapper-main">
            ...
            <div class="fukuoka-parco__body">
                <div class="fukuoka-parco__box">
                    <div class="box-line01">
                        <img src="/<?php echo DIRNAME; ?>/assets/images/box-line01.svg" alt="">
                    </div>
        ...
        <section class="box-studio">
            ...
            <div class="content-txt text-center">
                <div class="container">
                    <p class="fadeup">
                        福岡発のトレンドメディアARNEがプロデュースする、<br>韓国の「今」を体感できるPOP UP STUDIO。<br>日本初上陸のファッションブランドや最新コスメが登場。
                    </p>
                </div>
            </div>
            <div class="fashion-popup">
                <div class="container">
                    <div class="title-box text-center">
                        <h3>FASHION</h3>
                        <p class="fadeup">
                            多数のK-POPアイドルが愛用する2つの韓国ファッションブランド王道Y2KブランドMSKN2ND（ムンスグォンセカンド）、
                        </p>
                        <p class="fadeup">
                            そして大流行バレエコアスタイルのPAIN OR PLEASURE（ペインオアプレジャー）が日本初上陸！
                        </p>
                        <p class="fadeup">
                            さらに、各ブランドでサンリオ「クロミ」とのコラボアイテムも限定発売！
                        </p>
                    </div>
                </div>
            </div>
            <div class="list-fashion">
                <div class="container">
                    <div class="item-fashion">
                        <div class="brand">
                            <div class="avr-brand"><img src="assets/images/brand-2.webp" alt="painorpleasure"></div>
                        </div>
                            ...
                            <div class="left-txt">
                                <div class="info-brand">
                                    ...
                                    <div class="insta insta-painorpleasure">
                                        <a href="https://www.instagram.com/painorpleasure_official/" target="_blank"><img src="assets/images/painorpleasure-ins.png" alt="instagram"></a>
                                    </div>
                                    <div class="date-place">
                                        <div class="date">11/21<span>(水)</span>-11/25<span>(月)</span></div>
                                        <div class="place">
                                            <div class="icon">
                            ...
                            <div class="list-product swiper-container">
                                <div class="slide-product swiper-wrapper">
                                    <div class="item-slide fadeup delay-1 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-2-1.png" alt="painorpleasure"></div>
                                    </div>
                                    <div class="item-slide fadeup delay-2 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-2-2.png" alt="painorpleasure"></div>
                                    </div>
                                    <div class="item-slide fadeup delay-3 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-2-3.jpg" alt="painorpleasure"></div>
                                    </div>
                                </div>
                                <div class="swiper-button-prev">
                                    <button type="button" class="slick-custom-arrow slick-prev"><img src="/page/korean-pop-week/assets/images/arrow-left.svg" class="" alt="icon"></button>
                                </div>
                                <div class="swiper-button-next">
                                    <button type="button" class="slick-custom-arrow slick-next"><img src="/page/korean-pop-week/assets/images/arrow-right.svg" class="" alt="icon"></button>
                                </div>
                                <div class="note-text">
                                    ※画像はイメージです
                                </div>
                                <div class="view-more text-center">
                                    <a href="https://fukuoka.parco.jp/pnews/detail/?id=30451" target="_blank">
                                        <span>
                                            <img src="assets/images/viewmore.svg" alt="view more">
                                        </span>
                    ...
                    <div class="item-fashion">
                        <div class="brand">
                            <div class="avr-brand"><img src="assets/images/brand-1.webp" alt="MSKN2ND"></div>
                        </div>
                        <div class="content-item-fashion">
                            <div class="left-txt">
                                <div class="info-brand">
                                    ...
                                    <div class="date-place">
                                        <div class="date">11/27<span>(水)</span>-12/1<span>(日)</span></div>
                                        <div class="place">
                                            <div class="icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18.364" height="22" viewBox="0 0 18.364 22">
                                                    <g id="Icon_feather-map-pin" data-name="Icon feather-map-pin" transform="translate(-3.5 -0.5)">
                            ...
                            <div class="list-product swiper-container">
                                <div class="slide-product swiper-wrapper">
                                    <div class="item-slide fadeup delay-1 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-1-1.png" alt="MSKN2ND"></div>
                                    </div>
                                    <div class="item-slide fadeup delay-2 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-1-2.png" alt="MSKN2ND"></div>
                                    </div>
                                    <div class="item-slide fadeup delay-3 swiper-slide">
                                        <div class="avarta"><img src="assets/images/fs-1-3.jpg" alt="MSKN2ND"></div>
                                    </div>
                                </div>
                                <div class="swiper-button-prev">
                                    <button type="button" class="slick-custom-arrow slick-prev"><img src="/page/korean-pop-week/assets/images/arrow-left.svg" class="" alt=""></button>
                                </div>
                                <div class="swiper-button-next">
                                    <button type="button" class="slick-custom-arrow slick-next"><img src="/page/korean-pop-week/assets/images/arrow-right.svg" class="" alt=""></button>
                                </div>
                                <div class="note-text">
                                    ※画像はイメージです
                                </div>
        ...
        <section id="cosme" class="box-cosme fadeup">
            ...
            <div class="container">
                ...
                <div class="content-txt fadeup">
                    最新の韓国コスメが無料で体験できるBeauty MINUTEが日本初上陸。<br>無料のカラー診断や診断結果から手軽に参加できるタッチアップ企画も！
                </div>

                <div class="beauty-minute">
                    <div class="date-place">
                        <div class="date">11/21<span>(木)</span>-12/1<span>(日)</span></div>
                        <div class="place">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18.364" height="22" viewBox="0 0 18.364 22">
                                    <g id="Icon_feather-map-pin" data-name="Icon feather-map-pin" transform="translate(-3.5 -0.5)">
                    ...
                    <div class="item-abs abs-1"><img src="assets/images/beauty-1.png" alt="COSME"></div>
                    <div class="item-abs abs-2"><img src="assets/images/beauty-2.jpg" alt="COSME"></div>
                    <div class="item-abs abs-3"><img src="assets/images/beauty-3.jpg" alt="COSME"></div>
                    <div class="item-abs abs-4"><img src="assets/images/beauty-4.jpg" alt="COSME"></div>
                    <div class="item-abs abs-5"><img src="assets/images/beauty-5.png" alt="COSME"></div>
                ...
                <div class="choi-mison" id="talk">
                    <div class="bg-avarta">
                        <picture>
                            ...
                            <img src="/<?php echo DIRNAME; ?>/assets/images/choi.png" alt="TALK EVENT">
                        </picture>
                    </div>
                    <div class="item-abs abs-1">
                        ...
                        <img src="assets/images/choi-1.webp" alt="世界的スタイリスト チェ・ミソンTALK EVENT">
                    </div>
                    <div class="item-abs abs-2"><img src="assets/images/choi-2.jpg" alt="世界的スタイリスト チェ・ミソンTALK EVENT"></div>
                    <div class="item-abs abs-3 bul-animation"><img src="assets/images/choi-3.png" alt="TALK EVENT"></div>
                    <div class="item-abs abs-4 bul-animation"><img src="assets/images/vd-6.png" alt="TALK EVENT"></div>
                    <div class="txt-mison">
                        <h3 class="fadeup">世界的スタイリスト<br>チェ・ミソン<br>TALK EVENT</h3>
                        <div class="date-place">
                            ...
                            <div class="place fadeup">
                                ...
                                <span>本館7F スーパースピンズ</span>
                            </div>
                        </div>
                        <div class="desc">
                            <p class="fadeup">
                               世界的K-POPアイドルを担当するスタイリスト チェ・ミソンさん <br>が来日。ゲストに水上凜巳花さん・大坪楓恋さん・濵嵜愛子さんをお呼びし、韓国のトレンドスタイルを解説します。<br>
                               チェ・ミソンさんのInstagramに掲載のスタイルブックも必見！<br>
                        ...
                        <div class="bott">
                            <ul>
                                <li>
                                    <a href="https://www.instagram.com/misuuuuun/" target="_blank">
                                ...
                                <li>
                                    <div class="view-more">
                                        <a href="https://fukuoka.parco.jp/pnews/detail/?id=30453">
                                            <span>
                                                <img src="assets/images/viewmore.svg" alt="view more">
                                            </span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20.653" height="5.918" viewBox="0 0 20.653 5.918">
                    ...
                    <div class="content-dj">
                        ...
                        <div class="info">
                            <div class="txt-mison">
                                ...
                                <div class="desc">
                                    <p class="fadeup">
                                        Stray Kidsオリジナルラベルドリンクを11/1から全国25施設で限定販売！
                                    </p>
                                    <p class="fadeup">
                                        SKZ自販機にて９種からランダムに購入できます。（売価800円）
                                    </p>
                                    <p class="fadeup">
                                        特別なサイン入り缶が出てくるかも！？お楽しみください！
                                    </p>
                                    <p class="fadeup">
                                        詳細は"VIEW MORE"をご確認ください。
                                    </p>
                                </div>
                                <div class="bott">
                                    <ul>
                                        <li>
                                            <div class="view-more">
                                                <a href="https://fukuoka.parco.jp/pnews/detail/?id=30454" target="_blank">
                                                    <span>
                                                        <img src="assets/images/viewmore.svg" alt="view more">
                                                    </span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20.653" height="5.918" viewBox="0 0 20.653 5.918">
        ...
        <section id="novelty" class="box-novelty fadeup">
            <div class="container">
                <div class="content-novelty">
                    <div class="line text-center"><img src="assets/images/txt-novelty.png" alt="SPECIAL NOVELTY"></div>
                    <div class="txt-novelty">
                        <div class="avarta text-center">
                            <div class="avarta-item">
                                <div class="txt-novelty-ttl">
                                    <img src="assets/images/novelty-title.svg" alt="NOVELTY">
                                </div>
                                <img src="assets/images/ministicker_sample.png" alt="SPECIAL NOVELTY">
                            </div>
                            <div class="avarta-item">
                                <div class="txt-novelty-ttl">
                                    <img src="assets/images/novelty-title.svg" alt="NOVELTY">
                                </div>
                                <img src="assets/images/stickersheet_sample.png" alt="SPECIAL NOVELTY">
                            </div>
                        </div>
                        <div class="desc-novelty">
                            ...
                            <div class="desc fadeup">
                                福岡PARCO館内のチラシラックや、一部対象ショップにて「KOREAN POP <br>WEEK」のメインビジュアルを使用したステッカーシートとミニステッカーを設置！<br>
                                是非お手に取ってみてください♪<br>
                                ※なくなり次第終了となります。<br>
                                ※対象ショップ等詳細は"VIEW MORE"をご確認ください。<br>
                                ※画像はイメージです。
                            </div>
                            <div class="view-more text-center">
                                <a href="">
        ...
        <section class="box-video fadeup">
            ...
            <div class="container">
                <div class="content-video">
                    <div class="icon-video">
                        <img src="assets/images/icon-video-1.png" alt="icon">
                    </div>
                    <div class="pc-only content-video__body">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/GaGZ3TMlqFQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="icon-play">
                            <a href="javascript:void(0)">
                                <picture>
                                  ...
                                  <?php /* PCメイン画像 */ ?>
                                  <img src="/<?php echo DIRNAME; ?>/assets/images/icon-play-text.svg" alt="icon">
                                </picture>
                            </a>
                        </div>
                    </div>

                    <div class="sp-only content-video-mb">
                        <iframe width="452" height="804" src="https://www.youtube.com/embed/V4qBQZEoVBk" title="KOREAN POP WEEK｜福岡PARCO" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        <div class="icon-play">
                            <a href="javascript:void(0)">
                                <picture>
                                  <?php /* SPメイン画像 */ ?>
            ...
            <div class="bubbles">
                <div class="bubble bubble-1"><img src="assets/images/vd-1.png" alt="icon"></div>
                <div class="bubble bubble-2"><img src="assets/images/vd-2.png" alt="icon"></div>
                <div class="bubble bubble-3"><img src="assets/images/vd-3.png" alt="icon"></div>
                <div class="bubble bubble-4"><img src="assets/images/vd-4.png" alt="icon"></div>
                <div class="bubble bubble-5"><img src="assets/images/vd-5.png" alt="icon"></div>
                <div class="bubble bubble-6"><img src="assets/images/vd-6.png" alt="icon"></div>
                <div class="bubble bubble-7"><img src="assets/images/vd-7.png" alt="icon"></div>
            </div>
        </section>
