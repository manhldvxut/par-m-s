$(document).ready(function() {
    ...
    function updateLoading() {
        ...
        if (percentage < 100) {
            setTimeout(updateLoading, 50); // Adjusted to 50ms for 5 seconds total
    ...
    if($(window).innerWidth() > 769) {
        videoSplash_ver = $('#splash_ver_pc')[0];
    } else {
        videoSplash_ver = $('#splash_ver_sp')[0];
    }
    ...
    if($(window).innerWidth() > 769) {
       $('#splash_ver_pc').on('ended', function() { // show video 02
            $('.main-video').css({
                "opacity": 1,
                "visibility": "visible",
                "transition": ".3s all"
        ...
        $('#splash_ver_sp').on('ended', function() { // show video 02
            $('.main-video').css({
                "opacity": 1,
                "visibility": "visible",
                "transition": ".3s all"
